...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_photo_t, stringdata) + ofs \
...
void photo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (photo::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&photo::to_back)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject photo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_photo.data,
      qt_meta_data_photo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_photo.stringdata))
